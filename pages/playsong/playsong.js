...
Page({
  ...
  onLoad:function(options){
    this.setData({
      ...
      s: 0,  //秒
      m: 0,  //分
      eleWidth: 0,//红色盒子移动的距离 =  当前的时间 / 总时长 * 100
      curM: 0
    })
      ...
      wx.getBackgroundAudioPlayerState({
        success: function (res) {
          ...
          that.setData({
            ...
            debugger: Math.floor(res.duration),
            s: Math.floor(res.duration / 60), //秒
            m: m,  //分
            eleWidth: res.currentPosition / res.duration * 100,  //红色盒子移动的距离=当前的时间 / 总时长 * 100
            curM: curM
          })
        }
      })
